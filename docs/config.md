...
- `poly_basis` (`str`): Basis for `poly_reparam` / `poly_residual` init. One of `"power"` (default), `"chebyshev"`, `"legendre"`, `"dct"` (cosine basis), `"bspline"` (open-uniform clamped spline basis).
