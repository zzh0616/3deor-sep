#!/usr/bin/env python3
"""
Collect and merge EoR amplitude-prior mode scan results from remote workers.
"""
...
from run_eor_amp_prior_scan import _candidate_summary, _write_markdown
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Collect EoR amp-prior scan outputs from remote workers.")
    parser.add_argument(
        "--dispatch-manifest",
        type=Path,
        required=True,
        help="Local dispatch manifest produced by dispatch_eor_amp_prior_remote.py.",
    )
...
def main() -> int:
    ...
    _write_markdown(merged_root / "eor_amp_summary_merged.md", ranked, baseline_fixed)
